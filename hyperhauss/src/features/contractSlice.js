...
/**
 * Note:
 * - We DO NOT create a wallet client at module top-level (no window usage here).
 * - Each write thunk will create a wallet client at call-time (inside browser).
 */

const initialState = {
  guildIds: [],
  guilds: [], // Each guild includes messages array
  status: "idle", // idle | loading | succeeded | failed
  error: null,
};
